...
public class Solution {
	...
	private static int req_q[] = new int[MAX]; // 요청 순서
	private static int req_size;
	private static int req_idx;
	private static int cmd_q[] = new int[MAX*2]; // 스케쥴링에 따른 Track 처리 순서
	...
	private static void load_data(int tc){
		track_size = sc.nextInt(); // 200
		track_head = sc.nextInt(); // 60
	...
	public static void main(String arg[]) throws Exception {
		...
		int total_score = 0;
		int T = sc.nextInt(); // 전체 테스트 케이스 50
