// record structure => str[][], hash[], flag
// 나만의 hash, LinkedList, 
// search => hashtable[field][my_hash(str)]
// add => hashtable[i][my_hash(str)] <= new element 대신 id // id++
// num_records = 0; <= initDB
// Record records[max]
// change => record를 없애고 변경된 상태로 다시 생성 // new_record => record + change_record
